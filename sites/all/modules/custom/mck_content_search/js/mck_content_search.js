      ...
      $(document).ready(function () {
        $('.mck-para-content-search').each(function () {
          ...
          $(window).on('scroll', function () {
            mckContentSearchFilterUpdateStickyFiltersWrapper();
            // clearTimeout(window.mckContentSearchFiltersScrolledFinished);
            // window.mckContentSearchFiltersScrolledFinished = setTimeout(function() {
            //   mckContentSearchFilterUpdateStickyFiltersWrapper();
            // }, 50);
          });
          ...
          $('.filter .add', $contentSearch).click(function () {
            ...
            // else {
            //   $('.filter .filter-items', $contentSearch).hide();
            //   $(this).closest('.filter').find('.filter-items').slideUp('fast');
            //   $('.filter .add', $contentSearch).removeClass('active');
          ...
          $('tr.content-search-list-item', $contentSearch).click(function () {
