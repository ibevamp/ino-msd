...
<div class="item profile-item">
  ...
  <div class="text-wrapper">
    <a class="item-title-link" href="#" data-capture-breadcrumb="true" data-breadcrumb-title="Our People">
      <h4 class="headline"><?php echo render($title) ?></h4>
    </a>
    <small class="jobtitle description"><?php echo render($content['field_job_title']) ?></small>
    <div class="description"><?php echo render($content['body']) ?></div>
  </div>
</div>
