...
<style type="text/css"> 
   .para-15192.navigation-r3 .global-primary-nav-r3 .primary-navigation>.nav-list>.nav-item>a:hover,
   .para-15192.navigation-r3 .global-primary-nav-r3 .primary-navigation>.nav-list>.nav-item.active>a
   {
		color:#e5910d!important ;
   }
   .para-15192.navigation-r3 .global-primary-nav-r3 .primary-navigation>.nav-list>.nav-item>a:hover:after,
   .para-15192.navigation-r3 .global-primary-nav-r3 .primary-navigation>.nav-list>.nav-item.active>a:after
   {
		background-color: #e5910d;
   } 
   .para-15192.navigation-r3 .global-primary-nav-r3 .primary-navigation>.nav-list>.nav-item .sub-nav a.sub-menu-item:hover {
	   color: #e5910d !important;
...
<header class="global-header global-header-r3 navigation-r3 custom-menu fixed-header new-logo-header  hide-logout para-15192" role="banner">
      ...
      <div class="main-nav-inner">
         ...
         <nav class="main-nav" data-level="-menu-levelundefined" role="menu">
            <ul class="nav-list nav-group-left">
               <li class="nav-item " aria-hidden="true" data-url="/msd/ino/sirius-contact-us" tabindex="-1">
                  ...
                  <ul class="sub-nav">
                     <li class="nav-item " aria-hidden="true" tabindex="-1">
                        <a class="sub-menu-item" href="https://solutions.mckinsey.com/msd/ino/sirius-homenew#about" tabindex="-1">
                        About Aperture  </a>
                     </li>
                     <li class="nav-item " aria-hidden="true" tabindex="-1">
                        <a class="sub-menu-item" href="https://solutions.mckinsey.com/msd/ino/sirius-homenew#solutions" tabindex="-1">
                        Solutions  </a>
                     </li>
                     <li class="nav-item " aria-hidden="true" tabindex="-1">
                        <a class="sub-menu-item" href="https://solutions.mckinsey.com/msd/ino/sirius-homenew#impact" tabindex="-1">
                        Impact Stories  </a>
                     </li>
                     <li class="nav-item " aria-hidden="true" tabindex="-1">
                        <a class="sub-menu-item" href="https://solutions.mckinsey.com/msd/ino/sirius-homenew#media" tabindex="-1">
                        Media Coverage  </a>
                     </li>
                     <li class="nav-item " aria-hidden="true" tabindex="-1">
                        <a class="sub-menu-item" href="https://solutions.mckinsey.com/msd/ino/sirius-homenew#team" tabindex="-1">
                        Team  </a>
                     </li>
                  </ul>
               </li>
               ...
               <li class="nav-item " aria-hidden="true" data-url="/msd/ino/sirius-contact-us" tabindex="-1">
                  ...
                  <ul class="sub-nav">
				    <li class="nav-item " aria-hidden="true" tabindex="-1">
                     ...
                     <li class="nav-item " aria-hidden="true" tabindex="-1">
                        <a class="sub-menu-item" href="https://solutions.mckinsey.com/msd/ino/sirius-homenew#solutions">
                        Solutions  </a>
                     </li>
                     <li class="nav-item " aria-hidden="true" tabindex="-1">
                        <a class="sub-menu-item" href="https://solutions.mckinsey.com/msd/ino/sirius-homenew#impact">
                        Impact Stories  </a>
                     </li>
                     <li class="nav-item " aria-hidden="true" tabindex="-1">
                        <a class="sub-menu-item" href="https://solutions.mckinsey.com/msd/ino/sirius-homenew#media">
                        Media Coverage  </a>
                     </li>
                     <li class="nav-item " aria-hidden="true" tabindex="-1">
                        <a class="sub-menu-item" href="https://solutions.mckinsey.com/msd/ino/sirius-homenew#team">
                        Team  </a>
                     </li>
                  </ul>
               </li>
