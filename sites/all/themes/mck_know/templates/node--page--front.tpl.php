...
<?php foreach (element_children($field_hero_images) as $key): ?>

  <div class="item">
<!-- 
  <?php $paragraph = reset($content['field_hero_images'][$key]['entity']['paragraphs_item']) ?> -->
    <div class="owlsubitems" style="transform: translate3d(0px, 0px, 0px); background-image: url( <?php echo render($paragraph['field_image'][0]['#item']['uri']) ? file_create_url($paragraph['field_image'][0]['#item']['uri']) : '' ?>)">
          
 <!--    <?php echo render($paragraph['field_image'][0]) ?> -->
    <div class="slider-wrapper">
      ...
      <!--   <div class="year">2017</div> -->
        ...
        <?php if (isset($paragraph['field_hero_description'][0])): ?>
          <p class="description">
            <?php echo render($paragraph['field_hero_description'][0]) ?>
          </p>
        <?php endif ?>
