...
<header class="global-header global-header-r3 navigation-r3" role="banner">
  ...
  <div class="nav-right">
    <button class="search-nav-button r2-search" type="button">
      <span class="visually-hidden">Toggle search field</span>
    </button>
    <button class="search-nav-button-close mobile r2-close" type="button">
      <span class="visually-hidden">Toggle search field</span>
    </button>
      ...
      <div class="sub-nav-search">
        <header>
          <form method="GET" action="<?php echo base_path() ?>search">
              <input class="search-nav-input" title="Search" name="search" placeholder="Type to search..." value="<?php echo check_plain($_GET['search']) ?>" aria-live="polite" type="search">
