...
<header class="global-header global-header-r3 navigation-r3 custom-menu fixed-header new-logo-header  hide-logout para-15143" role="banner">
               ...
               <li class="nav-item " aria-hidden="true" data-url="/msd/ino/sirius-homenew" tabindex="-1">
                  ...
                  <ul class="sub-nav">
                     <li class="nav-item " aria-hidden="true" tabindex="-1">
                        <a class="sub-menu-item" href="#about" tabindex="-1">
                        About Aperture  </a>
                     </li>
                     <li class="nav-item " aria-hidden="true" tabindex="-1">
                        <a class="sub-menu-item" href="#selling" tabindex="-1">
                        Solution Selling  </a>
                     </li>
                     <li class="nav-item " aria-hidden="true" tabindex="-1">
                        <a class="sub-menu-item" href="#solutions" tabindex="-1">
                        Solutions  </a>
                     </li>
                     <li class="nav-item " aria-hidden="true" tabindex="-1">
                        <a class="sub-menu-item" href="#impact" tabindex="-1">
                        Impact Stories  </a>
                     </li>
                     <li class="nav-item " aria-hidden="true" tabindex="-1">
                        <a class="sub-menu-item" href="#media" tabindex="-1">
                        Media Coverage  </a>
                     </li>
                     <li class="nav-item " aria-hidden="true" tabindex="-1">
                        <a class="sub-menu-item" href="#team" tabindex="-1">
                        Team  </a>
                     </li>
                  </ul>
               </li>
         ...
         <nav class="primary-navigation" role="navigation">
            <ul class="nav-list nav-group-left">
               <li class="nav-item " aria-hidden="true" data-url="/msd/ino/sirius-homenew" tabindex="-1">
                  ...
                  <ul class="sub-nav">
                     <li class="nav-item " aria-hidden="true" tabindex="-1">
                        <a class="sub-menu-item" href="#about">
                        About Aperture  </a>
                     </li>
                     <li class="nav-item " aria-hidden="true" tabindex="-1">
                        <a class="sub-menu-item" href="#selling">
                        Solution Selling  </a>
                     </li>
                     <li class="nav-item " aria-hidden="true" tabindex="-1">
                        <a class="sub-menu-item" href="#solutions">
                        Solutions  </a>
                     </li>
                     <li class="nav-item " aria-hidden="true" tabindex="-1">
                        <a class="sub-menu-item" href="#impact">
                        Impact Stories  </a>
                     </li>
                     <li class="nav-item " aria-hidden="true" tabindex="-1">
                        <a class="sub-menu-item" href="#media">
                        Media Coverage  </a>
                     </li>
                     <li class="nav-item " aria-hidden="true" tabindex="-1">
                        <a class="sub-menu-item" href="#team">
                        Team  </a>
                     </li>
                  </ul>
               </li>
